       ...
       for(int i=0; i<Dis_Bat; i++){
       	...
       	for(int j=0; j<line; j++){
       		...
       		if(strcmp(distinct_batsman[i],batsman[j])==0){
       			...
       			(B[i].balls)++;
       	        if(strcmp(str[i][4],"FOUR,")==0)
       	        	(B[i].runs)+=4;
       	       if(strcmp(str[i][4],"SIX,")==0)
       	            (B[i].runs)+=6;
       	        if(strcmp(str[i][4],"OUT")==0)
       	        	(B[i].status)='b';
       	        if(strcmp(str[i][4],"1")==0)
       	        	(B[i].runs)+=1;
       	        if(strcmp(str[i][4],"2")==0)
       	        	(B[i].runs)+=2;
       	        if(strcmp(str[i][4],"3")==0)
       	        	(B[i].runs)+=3;
       	        if(strcmp(str[i][4],"5")==0)
       	        	(B[i].runs)+=5;
       		}
